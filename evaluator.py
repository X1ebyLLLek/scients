...
from sklearn.metrics import precision_recall_fscore_support, roc_auc_score, confusion_matrix, recall_score
from config import Config

def evaluate_model(model, test_loader, anomaly_threshold, device):
    """
    ...
    suspicious_threshold = anomaly_threshold * Config.SUSPICIOUS_THRESHOLD_MULTIPLIER
